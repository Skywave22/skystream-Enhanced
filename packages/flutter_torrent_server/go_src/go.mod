...
// Build with a patched stdlib. go1.26.5 and earlier carry advisories this
// server reaches: net/http, net/url, crypto/tls, encoding/xml, encoding/asn1.
// The go command fetches this toolchain on demand, so no local install is
// needed - see govulncheck in BUILD_INSTRUCTIONS.md.
toolchain go1.26.8
