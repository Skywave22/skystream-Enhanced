...
/// Why the sheet was opened. Both actions stay available on every row; the
/// mode only decides the default tap action and the initial filtering.
...
/// Grab-handle + poster + title block shared by both sheets.
